...
export default function BingoCell({ cell, selected, percent, showStats, checkStyle, shape, accent, onToggle }) {
  ...
  return (
    <button
      ...
      className={`group relative flex ${aspect} flex-col items-center justify-center overflow-hidden border p-1.5 text-center transition-colors duration-150 ${radius} ${
    ...
    >
      ...
      <span
        className={`relative z-10 line-clamp-3 text-[0.47rem] font-medium leading-tight sm:text-sm ${
