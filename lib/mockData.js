...
export const CATEGORIES = [
  ...
  { slug: 'movies', label: 'Film & Dizi', accent: '#FF4B6E' },
  { slug: 'food', label: 'Yemek', accent: '#FF8A3D' },
  { slug: 'travel', label: 'Seyahat', accent: '#4FA3FF' },
  { slug: 'sports', label: 'Spor', accent: '#B98CFF' },
  { slug: 'books', label: 'Kitap', accent: '#8B6F47' },
  { slug: 'lifestyle', label: 'Yaşam Tarzı', accent: '#F06EC7' },
  { slug: 'work', label: 'İş', accent: '#64748B' },
  { slug: 'nature', label: 'Doğa', accent: '#22A06B' },
  { slug: 'other', label: 'Diğer', accent: '#9C9A92' },
];

export const USERS = [
  {
    id: 'u_asli', username: 'asli', displayName: 'Aslı Kaya',
  ...
  {
    id: 'u_deniz', username: 'deniz', displayName: 'Deniz Yıldız',
  ...
  {
    id: 'u_mert', username: 'mert', displayName: 'Mert Aydın',
  ...
  {
    id: 'u_ece', username: 'ece', displayName: 'Ece Demir',
  ...
  {
    id: 'u_can', username: 'can', displayName: 'Can Öztürk',
  ...
  {
    id: 'u_selin', username: 'selin', displayName: 'Selin Arslan',
  ...
  {
    id: 'u_leyla', username: 'leyla.gezer', displayName: 'Leyla Aksoy',
  ...
  {
    id: 'u_arda', username: 'ardakayitlari', displayName: 'Arda Ergin',
  ...
  {
    id: 'u_duru', username: 'duru.dogada', displayName: 'Duru Koç',
  ...
  {
    id: 'u_bora', username: 'bora.office', displayName: 'Bora Çetin',
  ...
  {
    id: 'u_ahmet_mod', username: 'ahmet.mod', displayName: 'Ahmet Şahin',
    bio: 'Topluluk ve içerik moderasyonu.', avatarColor: '#4DE0E0', avatarImage: null,
    isCreator: false, role: 'moderator', social: {}, following: [],
  },
  {
    id: 'u_zeynep_editor', username: 'zeynep.editor', displayName: 'Zeynep Kurt',
...
export const FEATURED_CATEGORIES = ['travel', 'food', 'movies', 'gaming', 'books', 'lifestyle'];
